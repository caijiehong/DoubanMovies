...
function sortables_init() {
    ...
    if(afterSortInit!=null)afterSortInit();
}
...
function ts_makeSortable(t) {
	...
	for (var i=0;i<firstRow.cells.length;i++) {
        ...
        cell .setAttribute('onclick','ts_resortTable(this, '+i+');');
		}
	}
...
//    if (itm.replace('/,/' , '').match(/^-?(\d+[,\.]?)+(E[-+][\d]+)?%?$/)) sortfn = ts_sort_numeric;
